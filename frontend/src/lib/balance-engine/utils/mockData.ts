...
export const mockTransactions: Transaction[] = [
  ...
  },
  {
    ...
    amount: 175000,
    type: TransactionType.SALARY,
    date: new Date(Date.now() - 66 * 86400000).toISOString(),
    status: TransactionStatus.COMPLETED,
    currency: 'INR',
    tags: ['salary', 'income']
  },
  {
    id: 'txn_income_may_sal',
    accountId: 'acc_checking_1',
    category: 'Income',
    merchant: 'Tech Corp Inc.',
    description: 'Salary',
    amount: 175000,
    type: TransactionType.SALARY,
    date: new Date(Date.now() - 97 * 86400000).toISOString(),
    status: TransactionStatus.COMPLETED,
    currency: 'INR',
    tags: ['salary', 'income']
  },
  {
    id: 'txn_income_sep_sal',
    accountId: 'acc_checking_1',
    category: 'Income',
    merchant: 'Tech Corp Inc.',
